    ...
    <footer id="contact" className="bg-jrv-navy text-white">
      <div className="container mx-auto px-6 md:px-12 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="text-gray-400 mb-6">
                Soluções completas em estruturas metálicas e coberturas industriais com qualidade e comprometimento.
              </p>
            </div>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white bg-opacity-10 flex items-center justify-center hover:bg-jrv-red transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 text-jrv-red flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-jrv-red flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">Segunda - Sexta: 8h às 18h</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#hero" className="text-gray-300 hover:text-white transition-colors hover:underline">
                  Início
                </a>
              </li>
              <li>
                <a href="#services" className="text-gray-300 hover:text-white transition-colors hover:underline">
                  Serviços
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#benefits" className="text-gray-300 hover:text-white transition-colors hover:underline">
                  Benefícios
                </a>
              </li>
              <li>
                <a href="#quote" className="text-gray-300 hover:text-white transition-colors hover:underline">
                  Orçamento
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© {new Date().getFullYear()} JRVSTEEL Construções Metálicas. Todos os direitos reservados.</p>
